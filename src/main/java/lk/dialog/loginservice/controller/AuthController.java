...
import lk.dialog.loginservice.payload.JwtAuthenticationResponse;
import lk.dialog.loginservice.payload.LoginRequest;
import lk.dialog.loginservice.payload.SignUpRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        log.info("POST - User Login {}|{}",loginRequest.getUsernameOrEmail(),loginRequest.getPassword());
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        ...
        User user = new User(signUpRequest.getName(), signUpRequest.getUsername(),
                signUpRequest.getEmail(), signUpRequest.getPassword(),"INACTIVE");
